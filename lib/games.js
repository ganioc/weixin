...
module.exports = function(app){
  ...
  app.get('/game/publish/:id/:game',function(req,res){
	...
	function(err, doc){
	  ...
	  for(var j=0; j< doc.patches.length; j++){
	    var prefixTemp = doc.patches[j].name;
	    lst[prefixTemp + '_ad_text'] = '';
	    lst[prefixTemp + '_ad_link'] = '';
	    lst[prefixTemp + '_ad_image'] = '';
	  }
	  ...
	  for( var i=0; i< patches.length; i++){
	    ...
	    lst[prefix + '_ad_image'] = patches[i].ad_image || '';
	  }
